...
const makeStyles = (C: Colors) => StyleSheet.create({
  ...
  agentSelectorLabel: { color: C.textPrimary, fontSize: 15, fontWeight: "700" },
  agentSelectorDesc: { color: C.textMuted, fontSize: 12, marginTop: 2 },
  agentList: {
    backgroundColor: C.bgCard,
    borderRadius: 16,
    borderWidth: 1,
  ...
  agentListItemActive: { backgroundColor: `${C.primary}10` },
  agentListIcon: { width: 32, height: 32, borderRadius: 8, alignItems: "center", justifyContent: "center" },
  agentListLabel: { color: C.textPrimary, fontSize: 14, fontWeight: "600" },
  agentListDesc: { color: C.textMuted, fontSize: 11, marginTop: 1 },
  sectionTitle: { color: C.textSecondary, fontSize: 13, fontWeight: "600", textTransform: "uppercase", letterSpacing: 0.5 },
  exemplesList: { gap: 8 },
  exempleChip: {
    flexDirection: "row",
    alignItems: "center",
  ...
  exempleText: { color: C.textSecondary, fontSize: 13, flex: 1 },
  resultCard: {
    backgroundColor: C.bgCard,
    borderRadius: 16,
    padding: 16,
  ...
  clearBtn: { padding: 2 },
  resultText: { color: C.textSecondary, fontSize: 14, lineHeight: 22 },
  inputBar: {
    flexDirection: "row",
    alignItems: "flex-end",
    padding: 12,
